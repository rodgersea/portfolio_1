...
$("body").on("click", "#act-rock", function() {
    itme.empty()
    itme.text("ROCK CLIMBING")
    $(".act-desc").empty()
...
$("body").on("click", "#act-run", function() {
    itme.empty()
    itme.text("RUNNING")
    $(".act-desc").remove()
...
$("body").on("click", "#act-read", function() {
    itme.empty()
    itme.text("READING")
    $(".act-desc").remove()
...
$("body").on("click", "#act-sl", function() {
    itme.empty()
    itme.text("SLACKLINING")
    $(".act-desc").remove()
    $("#activity-split").append(`<div class="act-desc">I was introduced to slacklining early in college and I spent an 
    embarassingly long time practicing all kinds of tricks and movement
    with the slackline.</div>`)
})

$("body").on("click", "#act-disc", function() {
    itme.empty()
    itme.text("DISC GOLF")
    $(".act-desc").remove()
